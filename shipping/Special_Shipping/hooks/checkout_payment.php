...
<div class="row">
  <div class="col-sm-12 col-lg-12 large-margin-bottom">  
    <h1 class="loaded7_heading_h1"><?php echo $lC_Language->get('text_checkout'); ?></h1>
    <?php 
      ...
      <div id="content-checkout-payment-container">
        <div class="panel panel-default no-margin-bottom">
          <div class="panel-heading cursor-pointer" onclick="window.location.href='<?php echo lc_href_link(FILENAME_CHECKOUT, 'shipping', 'SSL'); ?>'">
            <h3 class="loaded7_heading_h3 no-margin-top no-margin-bottom"><?php echo $lC_Language->get('box_ordering_steps_delivery'); ?></h3>
          </div>
        </div>
        <div class="clearfix panel panel-default no-margin-bottom">
          <div class="panel-heading">
            <h3 class="loaded7_heading_h3 no-margin-top no-margin-bottom"><?php echo $lC_Language->get('box_ordering_steps_payment'); ?></h3>
          </div>
          <div class="panel-body no-padding-bottom">
            <div class="row">
              <div class="col-sm-4 col-lg-4">
                <div class="well relative no-padding-bottom">
                  <h4 class="loaded7_heading_h4 no-margin-top"><?php echo $lC_Language->get('ship_to_address'); ?></h4>
                  <address>
                ...
                <div class="well relative clearfix padding-bottom"> 
                  <h4 class="loaded7_heading_h4 no-margin-top"><?php echo $lC_Language->get('shipping_method_heading'); ?></h4>
              ...
              <div class="col-sm-8 col-lg-8">
                <div class="well relative">
                  <h4 class="loaded7_heading_h4 no-margin-top"><?php echo $lC_Language->get('bill_to_address'); ?></h4>
                ...
                <h3 class="loaded7_heading_h3 no-margin-top"><?php echo $lC_Language->get('payment_method_title'); ?></h3>
                <?php 
                ...
                if ($lC_Customer->isLoggedOn() !== false) {
                  if (defined('MODULE_SERVICES_INSTALLED') && in_array('coupons', explode(';', MODULE_SERVICES_INSTALLED)) && 
                    ...
                    ?>
                    <div class="well">
                      <h3 class="loaded7_heading_h3 no-margin-top"><?php echo $lC_Language->get('text_coupon_code_heading'); ?></h3>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="loaded7_heading_h3 no-margin-top no-margin-bottom"><?php echo $lC_Language->get('box_ordering_steps_confirmation'); ?></h3>
          </div>
        </div> 
      </div> 
    </form> 
