...
/**
  ...
  @version    $Id: controller.php v1.0 2013-05-20 datazen $
*/
class Store_Pickup extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Store_Pickup() {    
    ...
    */    
    $this->_code = 'Store_Pickup';       
   /**
    * The addon title used in the addons store listing
    */     
    $this->_title = $lC_Language->get('addon_shipping_pickup_title');
   /**
    * The addon description used in the addons store listing
    */     
    $this->_description = $lC_Language->get('addon_shipping_pickup_description');
   /**
    * The developers name
    */    
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/pickup.png');
   /**
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Sort Order', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_SORT_ORDER', '0', 'Sort order of display. Lowest is displayed first.', '6', '0', '', '', now())");
  }
 /**
