...
class Authnet_SIM_Payments extends lC_Addon { // your addon must extend lC_Addon 
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Server', 'ADDONS_PAYMENT_" . strtoupper($this->_code) . "_TRANSACTION_TYPE', 'AUTH_CAPTURE', 'The transaction type.', '6', '0', 'lc_cfg_set_boolean_value(array(\'AUTH_CAPTURE\', \'AUTH_ONLY\'))', now())");
